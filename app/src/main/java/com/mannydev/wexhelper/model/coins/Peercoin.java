...
public class Peercoin extends Coin {
    private static final double KOMSA = 0.002;
    private static final String USD = "USD";
    private static final String BTC = "BTC";

    public Peercoin(Pair altBtc, Pair altUsd, Pair btcUsd) {
        super("PPC", altBtc, null, null, null, null, null, altUsd, null, btcUsd, null, null, null, null, null, null);
