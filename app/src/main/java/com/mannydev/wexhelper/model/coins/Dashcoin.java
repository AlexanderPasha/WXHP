package com.mannydev.wexhelper.model.coins;

import com.mannydev.wexhelper.controller.Price;
import com.mannydev.wexhelper.controller.Profit;
import com.mannydev.wexhelper.model.Coin;
import com.mannydev.wexhelper.model.Pair;
...
public class Dashcoin extends Coin {
    ...
    public Dashcoin(Pair altBtc, Pair altEth, Pair altEur, Pair altLtc, Pair altRur, Pair altUsd, Pair altZec, Pair btcUsd, Pair ethUsd, Pair eurUsd, Pair ltcUsd, Pair usdRur, Pair zecUsd) {
        super("DSH", altBtc, null, altEth, altEur, altLtc, altRur, altUsd, altZec, btcUsd, null, ethUsd, eurUsd, ltcUsd, usdRur, zecUsd);
