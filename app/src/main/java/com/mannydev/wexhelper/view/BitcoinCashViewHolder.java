...
public class BitcoinCashViewHolder extends MyViewHolder {
    TextView txtCoinName,txtUsdBuy,txtUsdSell,txtRubBuy,
            ...
            txtEthBuy, txtEthSell, txtEthSprd, txtLtcBuy,txtLtcSell, txtLtcSprd,
            txtZecBuy, txtZecSell, txtZecSprd, txtDshBuy, txtDshSell,txtDshSprd;
    ...
    public BitcoinCashViewHolder(View itemView) {
        ...
        txtDshBuy = itemView.findViewById(R.id.txtDshBuy);
        txtDshSell = itemView.findViewById(R.id.txtDshSell);
        txtDshSprd = itemView.findViewById(R.id.txtDshSprd);
    ...
    public void onBindCoinHolder(Coin coin){
        ...
        txtEthSprd.setText(String.valueOf(coin.getEthSprd()));
        ...
        txtDshBuy.setText(String.valueOf(coin.getDshBuy()));
        txtDshSell.setText(String.valueOf(coin.getDshSell()));
        txtDshSprd.setText(String.valueOf(coin.getDshSprd()));
        ...
        if(coin.getBestBuyProfit().equals("USD")){
            ...
            txtDshBuy.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            ...
            txtBtcBuy.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            txtDshBuy.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
        }else if (coin.getBestBuyProfit().equals("DSH")) {
            txtDshBuy.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorGreen));
            txtUsdBuy.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            txtRubBuy.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            txtEurBuy.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            txtEthBuy.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
        ...
        if(coin.getBestSellProfit().equals("USD")){
            ...
            txtDshSell.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            ...
            txtBtcSell.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            txtDshSell.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
        }else if (coin.getBestSellProfit().equals("DSH")){
            txtDshSell.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorGreen));
            txtUsdSell.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            txtRubSell.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            txtEurSell.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
            txtEthSell.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.colorTextWhite));
